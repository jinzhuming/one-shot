...
截图后可使用底部工具条绘制箭头、形状、文字、序号、马赛克和聚光标注。按 **V** 切换选择工具后，可点击标注进行移动或缩放，也可以使用 **⌘D** 复制、**Delete** 删除；自由笔和荧光笔会自动平滑抖动。
...
默认 All-in-One 为 **⌃⌘A**，录屏为 **⌘⇧6**，截图默认保存到 `图片/Shot`。不会注册系统截图快捷键 ⌘⇧3 / ⌘⇧4 / ⌘⇧5。
